...
class Geo(object):
    ...
    def log_cache(self, url, message, date_visited, tb=True):
        ...
        if tb:
            self.br[
                "ctl00$ContentBody$LogBookPanel1$uxTrackables$hdnSelectedActions"] = "4996238_Visited"
...
if __name__ == "__main__":
    ...
    urls = [
        # "http://www.geocaching.com/geocache/GC286C1_vetrne-mlyny-na-decinsku-9-svetliny",
        "http://www.geocaching.com/geocache/GC5NGBE_lesni-zabavna-stezka-13-finish",
        "http://www.geocaching.com/geocache/GC5BERM_lesni-zabavna-stezka-11-cestou-do-podluzi",
        "http://www.geocaching.com/geocache/GC5ACTP_lesni-zabavna-stezka-10-vylov-kesku",
        "http://www.geocaching.com/geocache/GC5AQY9_lesni-zabavna-stezka-9-mechove-kameny",
        "http://www.geocaching.com/geocache/GC5AAV6_lesni-zabavna-stezka-8-bozi-muka",
        "http://www.geocaching.com/geocache/GC5AATC_lesni-zabavna-stezka-7-zajimava-kes",
        "http://www.geocaching.com/geocache/GC5AARQ_lesni-zabavna-stezka-6-konciny-kostelniho-lesa",
        "http://www.geocaching.com/geocache/GC5AQZA_lesni-zabavna-stezka-5-u-mytinky",
        "http://www.geocaching.com/geocache/GC5AARB_lesni-zabavna-stezka-4-za-oznacenym-stromem",
        "http://www.geocaching.com/geocache/GC5AANV_lesni-zabavna-stezka-3-u-vysilace",
        "http://www.geocaching.com/geocache/GC5AAKT_lesni-zabavna-stezka-2-lesni-strazce",
        "http://www.geocaching.com/geocache/GC5NGBB_lesni-zabavna-stezka-1-start",
    ]
    message = "Moc povedena serie! Odloveno s Karel55555, Radka55555 a vernou geofenou. Diky!"
    g = Geo()
    print 'login'
    g.login('', '')
    ...
    for link in urls:
        print 'logging: ' + link
        g.log_cache(url=link, message=message, date_visited="24.May.2015")